            ...
            <div class="col-lg-6">
                <div class="about-right wow fadeInRight" data-wow-delay=".25s">
                    <div class="site-heading mb-3">
                        ...
                        <h2 class="site-title">
                            Dedicated to better health through trusted medicines.
                        </h2>
                    </div>
                    <p>
                        Sidmus Medi Corporation is a Guwahati-based pharmaceutical company committed to improving healthcare and well-being in Assam and the wider Northeastern region of India. Founded with a vision to provide safe, effective, and affordable medicines, we focus on quality, innovation, and trust. Our core philosophy revolves around enhancing the lives of individuals and communities by delivering reliable healthcare solutions.
                    </p>
                    ...
                    <a href="contact" class="theme-btn mt-4">Contact Us<i
...
<!-- choose-area -->
<div class="choose-area bg py-70 mb-70">
    <div class="container">
